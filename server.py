...
# Copyright 2023 Favour Nwachukwu, Abram Hindle, Eddie Antonio Santos
...
# This code was made for CMPUT 404 - Fall 2023 - Assignment 1
...
class MyWebServer(socketserver.BaseRequestHandler):
    ...
    def handle(self):
        self.data = self.request.recv(1024).strip()  # information from the client including http methods and paths.
